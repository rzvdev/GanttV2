...
namespace ganntproj1
    ...
    public static class Extensions
        ...
        public static void DrawImbeddedImage<T>(this IEnumerable<T> list,
            ...
            foreach (T t in list)
                {
                if (t is TableViewPrint.ImbeddedImage)
                    {
                    TableViewPrint.ImbeddedImage ii = (TableViewPrint.ImbeddedImage)Convert.ChangeType(t, typeof(TableViewPrint.ImbeddedImage));
