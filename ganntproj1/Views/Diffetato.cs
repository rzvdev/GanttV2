namespace ganntproj1
{
    ...
    public partial class Diffetato : Form
    {
        ...
        private void tableV_dbc(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            //tb.Columns["% tess"].DefaultCellStyle.BackColor = tableView1.ColumnHeadersDefaultCellStyle.BackColor;
            //tb.Columns["% conf"].DefaultCellStyle.BackColor = tableView1.ColumnHeadersDefaultCellStyle.BackColor;
            //tb.Columns["DIFF TESS"].HeaderCell.Style.BackColor = tableView1.ColumnHeadersDefaultCellStyle.BackColor;
            //tb.Columns["% tess"].HeaderCell.Style.BackColor = Color.Gainsboro;
            //tb.Columns["DIFF CONF"].HeaderCell.Style.BackColor = tableView1.ColumnHeadersDefaultCellStyle.BackColor;
            //tb.Columns["% conf"].HeaderCell.Style.BackColor = tableView1.ColumnHeadersDefaultCellStyle.BackColor;
