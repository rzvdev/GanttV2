namespace ganntproj1
{
    ...
    public partial class Diffetato : Form
    {
        ...
        public void LoadReportByDate(bool byDate)
        {
            ...
            dt.Columns.Add("TESS.");
            dt.Columns.Add("CAPI ROTTI");       //ramm conf + ram tess
            dt.Columns.Add("%");        //rotti / carico
            dt.Columns.Add("RAMM CONF");
            dt.Columns.Add("RAMM TESS");
            dt.Columns.Add("DIFF TESS", typeof(double));    //tot!       //db
            dt.Columns.Add("% tess", typeof(double));   //tot!       // tess / carico * 100
            dt.Columns.Add("DIFF CONF", typeof(double));     //tot!       //db
            dt.Columns.Add("% conf", typeof(double));   //tot! //conf / carico * 100
            ...
            if (byDate)
            {
             ...
             "where Comenzi.department='" + Store.Default.selDept + "' and comenzi.dataLivrare between '" + from + "' and '" + to + "'";
            }
            else
            {
                query = "select " +
             ...
             "comenzi.def_tess, comenzi.diff_t " +
             "from comenzi inner join articole on comenzi.idarticol = articole.id " +
             "where Comenzi.department='" + Store.Default.selDept + "'";
            }
        ...
        private void tableV_dbc(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            tb.GridColor = Color.White;
            tb.ColumnHeadersDefaultCellStyle.BackColor = Color.LightBlue;
            ...
            tb.Columns["Comm."].DefaultCellStyle.BackColor = Color.Yellow;
            tb.Columns["DIFF"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["CAPI ROTTI"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["%"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["RAMM CONF"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["RAMM TESS"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["% tess"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["% conf"].DefaultCellStyle.BackColor = Color.Gainsboro;
            tb.Columns["DIFF TESS"].HeaderCell.Style.BackColor = Color.Gold;
            tb.Columns["% tess"].HeaderCell.Style.BackColor = Color.Gainsboro;
            tb.Columns["DIFF CONF"].HeaderCell.Style.BackColor = Color.Gold;
            tb.Columns["% conf"].HeaderCell.Style.BackColor = Color.Gainsboro;
            ...
            tb.Rows[0].DefaultCellStyle.SelectionBackColor = Color.White;
